		<div class="col-lg-8">
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					...
					<span style="font-size:10px; margin-left:10px;"><i>Note: Avoid using inappropriate language and hate speech to avoid banning of your account!</i></span>
					<div style="height:10px;"></div>
				...
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Type message..." id="chat_msg" maxlength="500"> 
